        ...
        .then((works) => {
            ...
            works.forEach((work) => {
                ...
                trashCan.addEventListener("click", function (event) {
                    ...
                    const shouldDelete = confirm("Voulez-vous supprimer cet élément ?");
                ...
                const deleteWorks = async function (id) {
                    const elementToDelete = document.getElementById(`edit-${id}`);
...
// Your main functionality, including the modalFunction
...
function closeModal() {
    ...
    closeX.addEventListener("click", function () {
        isModalOpen = false;  // Set the flag to false
        const modalTag = document.getElementById('modale');
        const modalContent = document.querySelector('.modal-content');
    ...
    window.addEventListener("click", function (event) {
        if (event.target == modalOverlay && isModalOpen) {
            isModalOpen = false;  // Set the flag to false
            const modalTag = document.getElementById('modale');
            const modalContent = document.querySelector('.modal-content');
            modalTag.classList.add("d-none");
...
export { setupAdminMode, createModalLink, createAdminNav, logOutBtn, renderMiniWorks, modalFunction };
